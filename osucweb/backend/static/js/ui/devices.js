            ...
            constructor: function(config) {
                ...
                config.tpl = ['<tpl for=".">',
                    '<div class="device" dataid="{id}">',
                        '<div style="background: url(/static/img/touch/device_{type}.png) 2% center no-repeat, url(/static/img/touch/active_{preferred}.png) 98% center no-repeat; background-size: 32px 32px; line-height: 2em">',
                            '<strong>{name}</strong>',
                        '</div>',
                    '</div>',
                '</tpl>'];
