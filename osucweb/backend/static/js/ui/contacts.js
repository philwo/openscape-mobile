            ...
            constructor: function(config) {
                ...
                config.tpl = ['<tpl for=".">',
                    '<div class="contact" dataid="{id}">',
                        '<div style="background: url(/static/img/touch/presence_{userStatus}.png) 2% center no-repeat, url(/static/img/touch/media_{mediaStatus}.png) 95% center no-repeat; background-size: 32px 32px; line-height: 2em">',
            ...
            constructor: function(config) {
                ...
                config.tpl = ['<tpl for=".">',
                    '<div class="contactdetail" dataid="{id}">',
                        '<div style="background: url(/static/{icon}) 2% center no-repeat; background-size: 48px 48px; line-height: 2em">',
