...
Ext.onReady(function() {
    ...
    osuc.geo = {
        start: function() {
            ...
            osuc.geo.mockLatitude = 48.0;
            osuc.geo.mockLongitude = 7.85;
        ...
        mock_my_position: function() {
            ...
            //setTimeout("osuc.data.contactsStore.loadPage(0)", 10000);
        },
        ...
        handle_error: function(code, message) {
            ...
            //alert("Geolocation Error:" + code + " " + message);
