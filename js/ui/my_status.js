            ...
            constructor: function(config) {
                ...
                config.tpl = ['<tpl for=".">',
                    '<div class="status" dataid="{id}">',
                        '<div style="background: url(/media/img/touch/presence_{id}.png) 2% center no-repeat, url(/media/img/touch/active_{active}.png) 98% center no-repeat; background-size: 32px 32px; line-height: 2em">',
                            '<strong>{name}</strong>',
                        '</div>',
                    '</div>',
                '</tpl>'];
